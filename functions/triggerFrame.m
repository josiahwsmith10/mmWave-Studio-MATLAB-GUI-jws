...
if ~app.isCaptureActive
    ...
    if (ErrStatus ~=30000)
        ...
        app.mmWaveStudioTextArea.Value = 'Configure DCA record success';
    end
    ...
    app.mmWaveStudioTextArea.Value = "Please stop frame before starting another (You are running a continuous frame)!";
end